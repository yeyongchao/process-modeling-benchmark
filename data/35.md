...
You have been asked to design the PI-controller, i.e., select the controller gain and the controller integral time, for $y^{\mathrm{sp}} = 0$ and $d = 1$ (unit step change in the load).
...
$$
\min_{k_c,\tau_I}\quad \int_0^{100}\left(|e(t)|+100|1+U(t)|\right)\,dt
$$
