...
$$\Delta L_i(t) = \begin{cases} L_i(t) - L_{i+1}(t) - H_{i+1}, & L_{i+1}(t) > H_{i+1} \\ L_i(t), & L_{i+1}(t) < H_{i+1} \end{cases}, \quad i \in \{1, 2, \dots, n-1\}$$
